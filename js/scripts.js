...
mr = (function (mr, $, window, document){
    ...
    var documentReady = function($){
        ...
        $('form.form-email, form[action*="getdrip.com"], form[action*="createsend.com"]').attr('novalidate', true).unbind('submit').on('submit', mr.forms.submit);
    ...
    mr.forms.submit = function(e){
        ...
        if (formAction.indexOf('createsend.com') !== -1 || formAction.indexOf('getdrip.com') !== -1 ) {
